...
namespace Task1
{
    ...
    {
        private const int IncorrectIndex = -1;
        ...
        public static void Sort(int[] numbers)
        {
            if (numbers == null)
            {
                throw new ArgumentNullException("Array should be not null.");
            }
        ...
        public static int IndexOf(Product[] products, Predicate<Product> predicate)
        {
            if (predicate == null)
            {
                throw new ArgumentNullException("Predicate should be not null.");
            }

            if (products == null)
            {
                throw new ArgumentNullException("Products should be not null.");
            }
